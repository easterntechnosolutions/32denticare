...
function enqueue_scripts_function() {
	...
	if (!is_admin()) {
		...
		wp_enqueue_style ( 'color_style', get_stylesheet_directory_uri() . '/css/color/color-1.css' );
...
// 			wp_enqueue_script( 'jquery-validate', get_stylesheet_directory_uri() . '/js/jquery-validate.js', array('jquery'), null, true );
			...
			wp_enqueue_script( 'rev-extension', get_stylesheet_directory_uri() . '/js/revolution/revolution.extension.actions.min.js', array('jquery'), null, true );
			wp_enqueue_script( 'rev-carousel', get_stylesheet_directory_uri() . '/js/revolution/revolution.extension.carousel.min.js', array('jquery'), null, true );
			wp_enqueue_script( 'rev-kenburn', get_stylesheet_directory_uri() . '/js/revolution/revolution.extension.kenburn.min.js', array('jquery'), null, true );
			wp_enqueue_script( 'rev-layeranimation', get_stylesheet_directory_uri() . '/js/revolution/revolution.extension.layeranimation.min.js', array('jquery'), null, true );
			wp_enqueue_script( 'rev-migration', get_stylesheet_directory_uri() . '/js/revolution/revolution.extension.migration.min.js', array('jquery'), null, true );
			wp_enqueue_script( 'rev-navigation', get_stylesheet_directory_uri() . '/js/revolution/revolution.extension.navigation.min.js', array('jquery'), null, true );
			wp_enqueue_script( 'rev-parallax', get_stylesheet_directory_uri() . '/js/revolution/revolution.extension.parallax.min.js', array('jquery'), null, true );
			wp_enqueue_script( 'rev-slideanims', get_stylesheet_directory_uri() . '/js/revolution/revolution.extension.slideanims.min.js', array('jquery'), null, true );
			wp_enqueue_script( 'rev-video', get_stylesheet_directory_uri() . '/js/revolution/revolution.extension.video.min.js', array('jquery'), null, true );
			wp_enqueue_script( 'owl-carousel', get_stylesheet_directory_uri() . '/js/owlcarousel/owl.carousel.min.js', array('jquery'), null, true );
			wp_enqueue_script( 'carousel', get_stylesheet_directory_uri() . '/js/owlcarousel/carousel.js', array('jquery', 'owl-carousel'), null, true );
 ...
 * Author: ETS.
 */
add_action('widgets_init','denticare_widgets_init');
function denticare_widgets_init() {
	register_sidebar(array(	
		'name'          => esc_html__('Page Sidebar', 'denticare'),
		'id'            => 'page-sidebar',
		'description'   => esc_html__('Page Sidebar', 'denticare'),
	...
	register_sidebar(array(	
		'name'          => esc_html__('Footer 1 Widget Area', 'denticare'),
		'id'            => 'footer-1',
		'description'   => esc_html__('Footer 1', 'denticare'),
	...
	register_sidebar(array(	
		'name'          => esc_html__('Footer 2 Widget Area', 'denticare'),
		'id'            => 'footer-2',
		'description'   => esc_html__('Footer 2', 'denticare'),
	...
	register_sidebar(array(	
		'name'          => esc_html__('Footer 3 Widget Area', 'denticare'),
		'id'            => 'footer-3',
		'description'   => esc_html__('Footer 3', 'denticare'),
		'before_widget' => '<aside id="%1$s" class="widget footer-widget links">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	...
	register_sidebar(array(	
		'name'          => esc_html__('Footer 4 Widget Area', 'denticare'),
		'id'            => 'footer-4',
		'description'   => esc_html__('Footer 4', 'denticare'),
		'before_widget' => '<aside id="%1$s" class="widget footer-widget links">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	...
	register_sidebar(array(	
		'name'          => esc_html__('Copyrights Widget Area', 'denticare'),
		'id'            => 'copyrights',
		'description'   => esc_html__('Copyrights Widget', 'denticare'),
