				...
				<table border="0" cellpadding="0" cellspacing="0" height="100%" .="100%" style="margin: 0 auto;">
					...
					<tr>
						<td align="center" valign="top" style="width: 100%;">
							<!-- Footer -->
							<table border="0" cellpadding="10" cellspacing="0" width="700" id="template_footer" style="background-color: #091D3E; width:100%; color: #FFF; margin-bottom: 40px; border-radius: 0 0 12px 12px; min-width: 500px;">
								<tr>
									<td valign="top">
										<table border="0" align="center" cellpadding="10" cellspacing="0" width="100%" style="text-align: center;">
											<tr align="center">
												<td valign="middle" id="credit" align="center" style="padding-bottom: 8px; display: block; text-align: center; ">
													<a target="_blank" href="<?php echo site_url(); ?>" style="font-weight:400;text-decoration:blink;color:#fff;font-size: 20px; text-align: center;">32 denti care & implant center</a>
												</td>
											</tr>
										</table>
									</td>
